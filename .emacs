...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (erlang transpose-frame transpose robe-mode robe company-lsp company company-mode yasnippet lsp-mode lsp-mode-ui elixir-mode csharp-mod inf-ruby json-mode counsel csharp-mode doom-themes haskell-mode magit swiper ivy paren-face aggressive-indent aggressive-indent-mode paredit use-package color-theme-sanityinc-tomorrow))))
(custom-set-faces
...
;; Used for Ruby autocompletion. To use run any Robe core command or just robe-start.
;; Requires a ruby console to be running (if nothing else use inf-ruby to start one).
;; Requires the following Ruby packages to be installed:
;; - pry
;; - pry-doc >= 0.6.0 (on MRI)
;; - method_source >= 0.8.2
;; Note that if a project is using Bundler, the dependencies have to be added to the Gemfile.
(use-package robe)
...
(use-package erlang
  :config
  (setq erlang-root-dir "C:\\Program Files\\erl10.1\\bin"
	erlang-man-root-dir "C:\\Program Files\\erl10.1\\man"))
