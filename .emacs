...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (csharp-mod inf-ruby json-mode counsel csharp-mode doom-themes haskell-mode magit swiper ivy paren-face aggressive-indent aggressive-indent-mode paredit use-package color-theme-sanityinc-tomorrow))))
(custom-set-faces
...
(use-package paredit 
  ...
  (global-set-key (kbd "M-SPC") 'paredit-open-round))
